...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=372899');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "372899");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "934ae1a4da0f5de037893b50103074222341b3b7a8b31b55de46297c33ecdb57");
define('CREATED_TIMESTAMP', "1755391800");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor372899');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor372899');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "zuhayrgim.github.io",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "zuhayrgim.github.io",
));
